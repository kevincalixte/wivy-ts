    ...
    return (
        <section className='mx-5'>
            ...
            <form method='POST' className='rounded-xs space-y-5'>
                ...
                <div>
                    <select name="subject" id="subject" className='w-full bg-white/8 rounded-xl px-3 py-2.5 focus:outline-0'>
                        <option value="">Choose a subject</option>
                    </select>
                </div>
                <div>
                    <textarea name="text" id="text" maxLength={200} className='w-full h-36 bg-white/8 rounded-xl resize-none overflow-hidden p-3 focus:outline-0' placeholder='Your message'></textarea>
                </div>
                <div>
